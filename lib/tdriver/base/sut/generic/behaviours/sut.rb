...
module MobyBehaviour
	...
	module SUT
		...
		#TODO: rething get_ui_dump and refresh --> functions!
...
=end
		...
		# Wrapper function to return parameters for this SUT
		# Uses the Parameter singleton to read the values from xml under group identified as this SUT
		# ==usage
		# sut.parameter('product') #returns the value for parameter 'product' for this particular sut
		# parameter file is stored under Moby folder in tdriver_parameters.xml
		# parameters for each sut are stored in the file under group tag with name attribute matching the SUT id
		#
		# ==params
		# parameter_name:: String representing the name of the parameter to be fetched.
		# default_value:: String representing the name of the parameter to be fetched.
		# ==return
