...
unless defined?( $source )
  ...
  abort "Abort: source folder not defined"
  
end

unless RDoc::RDoc::GENERATORS.has_key?( 'tdriver_behaviour_xml' )
  ...
  RDoc::RDoc.new.tap{ | rdoc |
    ...
    rdoc.install_generator( 'tdriver_behaviour_xml', 'TDriverBehaviourGenerator', File.expand_path( $0 ) )
    rdoc.document( 
      [
        '--inline-source', 
        '--op', File.expand_path( $destination || 'behaviour_xml/' ), 
